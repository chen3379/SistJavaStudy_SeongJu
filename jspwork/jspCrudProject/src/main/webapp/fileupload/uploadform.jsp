  ...
  <form action="uploadproc.jsp" method="post" enctype="multipart/form-data">
    ...
    <table class="table table-bordered" style="width: 500px;">
      ...
      <tr>
        ...
        <td><input type="text" name="subject" class="form-control" style="width: 300px;"></td>
      </tr>
      <tr>
        <th width="100" class="table-secondary">이미지</th>
        <td><input type="file" name="uploadFile" class="form-control" style="width: 300px;"></td>
      </tr>
      <tr>
        <td colspan="2" align="center"><button type="submit" class="btn btn-success">서버에 업로드</button></td>
      </tr>
