			...
			<table class="table table-bordered">
				...
				<tr>
					...
					<td><input type="text" name="name" class="form-control"
						value="<%=dto.getName()%>" required="required"
						style="width: 120px;"></td>
				</tr>
				<tr>
					<th width="100" class="table-success">연락처</th>
					<td><input type="text" name="hp" class="form-control"
						value="<%=dto.getHp()%>" required="required" style="width: 120px;"></td>
				</tr>
				<tr>
					<th width="100" class="table-success">운전면허</th>
					<td><input type="checkbox" name="driver" value="보유"
						<%="보유".equals(dto.getDriver()) ? "checked" : ""%>>&nbsp;보유</td>
				</tr>
				<tr>
					<th width="100" class="table-success">직업</th>
					<td><input type="text" name="job" class="form-control"
						value="<%=dto.getJob()%>" required="required"
						style="width: 120px;"></td>
				</tr>
				<tr>
					<td colspan="2" align="center"><input type="hidden" name="num"
						...
						<button type="button" class="btn btn-outline-success"
							onclick="location='memberList.jsp'">목록</button></td>
				</tr>
