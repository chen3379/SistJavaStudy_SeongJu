		...
		<ul class="pagination">
			<c:if test="${startPage > 1}">
				<li class="page-item"><a class="page-link"
					href="list?currentPage=${startPage-1}"><i
						class="bi bi-chevron-left"></i></a></li>
			</c:if>

			<c:forEach var="pp" begin="${startPage}" end="${endPage}">
				<li class="page-item ${currentPage == pp ? 'active' : ''}"><a
					class="page-link" href="list?currentPage=${pp}">${pp}</a></li>
			</c:forEach>

			<c:if test="${endPage < totalPage}">
				<li class="page-item"><a class="page-link"
					href="list?currentPage=${endPage+1}"><i
