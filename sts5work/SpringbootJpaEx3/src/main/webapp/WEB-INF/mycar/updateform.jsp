  ...
  <table class="table table-bordered" style="width: 400px;">
     ...
     <tr>
       ...
       <td>
         ...
         style="width: 120px;" value="${dto.carname }">
       </td>
     </tr>
     <tr>
     ...
     <tr>
       ...
       <td>
         ...
         style="width: 150px;" value="${dto.carprice}">
       </td>
     </tr>
     <tr>
       ...
       <td>
         ...
         style="width: 250px;" value="${dto.guipday}">
       </td>
     </tr>
     <tr>
       <td colspan="2" align="center">
         <button type="submit" class="btn btn-success btn-sm">DB저장</button>
       </td>
     </tr>
  </table>
</form>
